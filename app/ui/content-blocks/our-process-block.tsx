...
export function OurProcessBlock() {
  return (
    <div className="center-child-content bg-[--bg-dark] w-full text-white mt-12 py-20 lg:mt-16 lg:py-28 relative">
      ...
      <div className="absolute h-48 w-[200%] left-1/2 -translate-x-1/2 -z-10 bottom-full
        bg-gradient-to-t from-[--bg-dark] from-80% to-transparent
      ">
      </div>
      ...
      <div className="center-child-content">
        <div className="common-content-w common-content-p">
          ...
          <div className="absolute top-0 bottom-0 left-1/2 transform -translate-x-1/2">
            <div className="h-full w-px border-[1px] bottom-1 border-[--text-light] relative"></div>
        ...
        bg-gradient-to-b from-[--bg-dark] from-30% to-60% to-transparent
        ">
        </div>
